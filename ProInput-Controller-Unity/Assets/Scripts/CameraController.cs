...
public class CameraController : MonoBehaviour, IInputListener {
    ...
    public void NotifyRightClick(bool isRightClickPressed)
    {
        ...
        {
            var mouseMovement = new Vector2(mousePosition.x, mousePosition.y * (invertY ? 1 : -1));
